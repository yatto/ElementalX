...
#define gpio_EN_VDD_SYS 32  //MAX ADD DUMA
#define gpio_EN_VDD_BL PM8921_GPIO_PM_TO_SYS(23)	//panel VCC
#define gpio_LCD_BL_EN PM8921_GPIO_PM_TO_SYS(30)	//LCD_BL_EN DUMA
//#define gpio_LCD_BL_EN_SR1 PM8921_GPIO_PM_TO_SYS(30		//panel enable and backlight enable
//#define gpio_LCD_BL_EN_SR2 PM8921_GPIO_PM_TO_SYS(36)	//panel enable and backlight enable  DELETED FOR DUMA
#define gpio_LCD_BL_PWM PM8921_GPIO_PM_TO_SYS(26)	//backlight pwm
#define gpio_EN_VDD_PNL PM8921_GPIO_PM_TO_SYS(43)	//EN_VDD_PNL ADD DUMA
// duma deleted
...
//EN_VDD_SYS, only for duma
		...
		//LCD_BL_EN
		//gpio_LCD_BL_EN = gpio_LCD_BL_EN_SR2; removed duma
...
{
	/*lcd_type type = asustek_get_lcd_type();
	printk("%s: lcd_type=%d\n", __func__, type); COMMENTED FOR DUMA*/
